    ...
    def read_examples(input_file):
        with open(input_file, "r", encoding="utf-8") as f:
            ...
            for line in f.readlines():
                ...
                if "triples" in json_dic:
                    contexts = [contexts] * len(json_dic["question"]["choices"])
                    for i in range(len(json_dic["question"]["choices"])):
                        contexts[i] = "Evidence: " + json_dic['triples'][i] + "\t" + "Question: " + contexts[i]
                        # contexts[i] = "Question: " + contexts[i] + " " + "Evidence: " + json_dic['triples'][i]
